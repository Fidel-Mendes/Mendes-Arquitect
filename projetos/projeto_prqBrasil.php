...
<head>
    ...
    <link rel="stylesheet" href="css_projetos/projeto_prqBrasil.css">
...
<header>
    ...
    <main>
        <section class="all">
            ...
            <div class="texto">
                <h1>Parque Brasil</h1>
                <h2>&nbsp;&nbsp;&nbsp;O projeto foi desenvolvido pessoas 
                  que adoram desfrutar de bons momentos em casa com a 
                  família e os amigos. <br>
                  Pontuado por ciprestes e envolto por lavandas, o 
                  projeto paisagístico foi inspirado nos jardins 
                  italianos e conta ainda com um pergolado agradável 
                  que pode ser aproveitado tanto no inverno quanto no 
                  verão.
                  </h2>
                <div class="by">
        ...
        <a class="next" href="projeto_uluwatu.php">	<em>Next</em>&nbsp;&rarr;</a>
    </main>
