...
<head>
    <meta charset="UTF-8">
    <title>Parque Wild Mile | Mendes Arquitect</title>
    <link rel="stylesheet" href="../css/reset.css">
    <link rel="stylesheet" href="../css/menu.css">
    <link rel="stylesheet" href="../css/hover.css">
    <link rel="stylesheet" href="css_projetos/projeto_wildMile.css">
    ...
    <main>
        <section class="all">
            ...
            <div class="texto">
                ...
                <h2>&nbsp;&nbsp;&nbsp; Em uma parceria com empresas estatais e 
                    com o governo, a Mendes Arquitect projetou o parque com 
                    vista para o lago em uma tentativa de criar um meio de lazer 
                    que traga a sensação estética e sustentável que um parque 
                    realmente deveria trazer. O Wild Mile possui mais de 
                    m de áreas verdes. Grandes espaços públicos a céu 
                    aberto com paisagismo e equipamentos que estimulam a 
                    interação entre as pessoas e o lugar onde vivem.</h2>
                <div class="by">
                    <h2>Designed by: <a href="../arquitetos/brunaPontinelli.php">Bruna Pontinelli</a></h2>
                </div>
            </div>
        </section>
        <a class="next" href="projeto_hanazaki.php">	<em>Next</em>&nbsp;&rarr;</a>
    </main>
