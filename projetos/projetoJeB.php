...
<head>
    <meta charset="UTF-8">
    <title>Design J&B | Mendes Arquitect</title>
    <link rel="stylesheet" href="../css/reset.css">
    <link rel="stylesheet" href="../css/menu.css">
    <link rel="stylesheet" href="../css/hover.css">
    <link rel="stylesheet" href="css_projetos/projetoJeB.css">
...
<header>
    ...
    <main>
        <section class="all">
            ...
            <div class="texto">
                <h1>Projeto Joaquim & Bruna</h1>
                <h2>&nbsp;&nbsp;&nbsp; O design exterior tem uma vanguarda bastante ampla 
                  que tem como principal fundamento utilizar itens 
                  simples para construções surpreendentes e com designs 
                  à frente de sua época, é simplesmente uma casa moderna 
                  e imponente, que impressiona em cada detalhe.<br>
                  &nbsp;&nbsp;&nbsp; O terreno possui 700 m², a residência está distribuída 
                  em dois pavimentos, com uma área social generosa para 
                  receber familiares e amigos, uma área de serviço bem 
                  equipada para as demandas dos visitantes e uma área íntima 
                  confortável e aconchegante.</h2>

                <div class="by">
                    <h2>Designed by: <a href="../arquitetos/fabricioKurmann.php">Fabrício Kurmann</a></h2>
                </div>
            </div>
        </section>
        <a class="next" href="projetoMet.php">	<em>Next</em>&nbsp;&rarr;</a>
    </main>
