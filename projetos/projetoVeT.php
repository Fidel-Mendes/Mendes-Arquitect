...
<head>
    ...
    <link rel="stylesheet" href="css_projetos/projetoVet.css">
...
<body>
    ...
    <main>
        <section class="all">
            ...
            <div class="texto">
                <h1>Projeto Victor & Taina</h1>
                <h2>&nbsp;&nbsp;&nbsp;O design interior da mansão reflete o status social e os 
                    gostos pessoais de seu proprietário. Por exemplo, os 
                    quartos do primeiro andar são normalmente usados ​para 
                    entreter os hóspedes, enquanto os quartos do segundo andar 
                    são designados para tarefas administrativas, como papelada 
                    e armazenamento. As famílias podem reunir-se na sala 
                    confortável, arquitetada e projetada para ser um 
                    ambiente caloroso e especial.</h2>
                <div class="by">
                    <h2>Designed by: <a href="../arquitetos/fernandaMelo.php">Fernada Melo</a></h2>
                </div>
            </div>
        </section>
        <a class="next" href="projetoReD.php">	<em>Next</em>&nbsp;&rarr;</a>
    </main>
