...
<head>
    <meta charset="UTF-8">
    <title>Loja Westwing | Mendes Arquitect</title>
    <link rel="stylesheet" href="../css/reset.css">
    <link rel="stylesheet" href="../css/menu.css">
    <link rel="stylesheet" href="../css/hover.css">
    <link rel="stylesheet" href="css_projetos/projeto_westwing.css">
...
<header>
    ...
    <main>
        <section class="all">
            ...
            <div class="texto">
                <h1>Loja Westwing</h1>
                <h2>&nbsp;&nbsp;&nbsp; A sofisticação não está apenas 
                  em decorações luxuosas, a estrutura quando bem 
                  arquitetada encanta os olhos de quem vê, além do mais 
                  se você for criativo e pensar adiante quando o assusto 
                  for negócios. <br>
                  &nbsp;&nbsp;&nbsp;Loja comercial composta por 02 amplas salas, mezanino, 
                  copa, banheiro com acessibilidade e vagas rotativas 
                  na parte externa. <br>
                  &nbsp;&nbsp;&nbsp;Localiza-se próximo à supermercados, farmácias, posto 
                  de gasolina, hospital, escola e outros comércios em 
                  geral.
                  </h2>
                <div class="by">
                    <h2>Designed by: <a href="../arquitetos/rafaelBellini.php">Rafael Bellini</a></h2>
                </div>
            </div>
        </section>
        <a class="next" href="projeto_prqBrasil.php">	<em>Next</em>&nbsp;&rarr;</a>
    </main>
