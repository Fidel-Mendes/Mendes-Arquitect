...
<head>
    ...
    <link rel="stylesheet" href="css_projetos/projetoMet.css">
...
<header>
    ...
    <main>
        <section class="all">
            ...
            <div class="texto">
                <h1>Projeto Matheus & Biazinha</h1>
                <h2>&nbsp;&nbsp;&nbsp; Mansão desenhada à mão, planejada para comportar 
                  uma família O projeto arquitetônico foi desenvolvido 
                  em uma área com 650m² com ambientes amplos, confortáveis 
                  e conectados com a área exterior, perfeita para um 
                  encontro família aos finais de semana. O térreo, ao 
                  lado oeste, abriga a área social, a varanda e a 
                  piscina. E ao lado leste, uma suíte para hóspedes, 
                  lavabo, área de serviços, a cozinha e o espaço gourmet. Já a sala de jantar foi estrategicamente posicionada no centro, articulando a sala de estar, a cozinha e o gourmet.</h2>
                <div class="by">
                    <h2>Designed by: <a href="../arquitetos/fabricioKurmann.php">Fabrício Kurmann</a></h2>
                </div>
            </div>
        </section>
        <a class="next" href="projetoVeT.php">	<em>Next</em>&nbsp;&rarr;</a>
    </main>
