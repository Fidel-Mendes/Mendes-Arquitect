...
<head>
    <meta charset="UTF-8">
    <title>Jardim HanaZaki | Mendes Arquitect</title>
    <link rel="stylesheet" href="../css/reset.css">
    <link rel="stylesheet" href="../css/menu.css">
    <link rel="stylesheet" href="../css/hover.css">
    <link rel="stylesheet" href="css_projetos/projeto_hanazaki.css">
    ...
    <main>
        <section class="all">
            ...
            <div class="texto">
                ...
                <h2>&nbsp;&nbsp;&nbsp; O Jardim Hana Zaki foi projetado 
                  para dar vida à edificação, seja ela residencial, 
                  comercial, corporativa ou até mesmo industrial. Hoje, 
                  o jardim é muito mais do que um “gramado florido”. Para quebrar a monotonia, o estúdio 
                  decidiu criar uma abertura zenital que potencializou 
                  a iluminação natural para dentro dos ambientes. 
                  De dia, é quase que imperceptível. À noite, o efeito 
                  é inverso, já que a luz ilumina toda a fachada – quem 
                  vê de fora, pressupõe uma extensa luminária linear.</h2>
                <div class="by">
                    <h2>Designed by: <a href="../arquitetos/robertaMarroni.php">Roberta Marroni</a></h2>
                </div>
            </div>
        </section>
        <a class="next" href="projeto_westwing.php">	<em>Next</em>&nbsp;&rarr;</a>
    </main>
