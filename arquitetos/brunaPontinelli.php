...
<html lang="pt-br">
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="../icones/icone_navegador/favicon-16x16.png">
        ...
        <style>
            ...
            .first-section {
                background: url(../imagens/imagens_perfil/urbanismo2.jpg);
                background-size: cover;
            }

            .fundo-arquiteto {
                background: url(../imagens/imagens_perfil/background7.jpg);
                background-size: cover;
            }
        ...
        <main>
            ...
            <section class="first-section">
                <div class="first-section-conteudo">
                    <img src="../imagens/imagens_arquitetos/bruna_pontinelli.jpg" alt="Imagem de Perfil">
                    <h1 class="name">Bruna Pontinelli</h1>
                </div>
            </section>
                    ...
                    <div class="left">
                        ...
                        <div class="conteudo-left">
                            <table>
                                <tr>
                                    <td>Nome: </td>
                                    <td>Bruna Pontinelli</td>
                                </tr>
                                <tr>
                                    <td>Especialidade:</td>
                                    <td>Arquitetura Urbana</td>
                                </tr>
                                <tr>
                                    <td>Experiencia: </td>
                                    <td>4 anos de Atuação na área</td>
                                </tr>
                            </table>
                        </div>
                    </div>
                        ...
                        <div class="contato-conteudo">
                            <table>
                                <tr>
                                    ...
                                    <td>+55 11 98074-7785</td>
                                </tr>
                                <tr>
                                    <td><img src="../icones/arroba.png" alt=""></td>
                                    <td class="email">brunaPontinelli@gmail.com</td>
                                </tr>
                                <tr>
                                    <td><img src="../icones/instagram-black.png" alt=""></td>
                                    <td>bruna.Pontinelli_</td>
                                </tr>
                            </table>
                        </div>
                    </div>
