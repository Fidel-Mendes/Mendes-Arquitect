...
<html lang="pt-br">
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="../icones/icone_navegador/favicon-16x16.png">
        ...
        <style>
            ...
            .first-section {
                background: url(../imagens/imagens_perfil/residencial3.jpg);
                background-size: cover;
            }

            .fundo-arquiteto {
                background: url(../imagens/imagens_perfil/background3.jpg);
                background-size: cover;
            }
        ...
        <main>
            ...
            <section class="first-section">
                <div class="first-section-conteudo">
                    <img src="../imagens/imagens_arquitetos/fabricio_kurmann.jpg" alt="Imagem de Perfil">
                    <h1 class="name">Fabrício Kurmann</h1>
                </div>
            </section>
                    ...
                    <div class="left">
                        ...
                        <div class="conteudo-left">
                            <table>
                                <tr>
                                    <td>Nome: </td>
                                    <td>Fabrício Kurmann</td>
                                </tr>
                                <tr>
                                    <td>Especialidade:</td>
                                    <td>Arquitetura Residêncial</td>
                                </tr>
                                <tr>
                                    <td>Experiencia: </td>
                                    <td>6 anos de atuação na área</td>
                                </tr>
                            </table>
                        </div>
                    </div>
                        ...
                        <div class="contato-conteudo">
                            <table>
                                <tr>
                                    ...
                                    <td>+55 11 95668-6556</td>
                                </tr>
                                <tr>
                                    <td><img src="../icones/arroba.png" alt=""></td>
                                    <td class="email">fabriciokurmann@hotmail.com</td>
                                </tr>
                                <tr>
                                    <td><img src="../icones/instagram-black.png" alt=""></td>
                                    <td>OfabricioKurmann_</td>
                                </tr>
                            </table>
                        </div>
                    </div>
