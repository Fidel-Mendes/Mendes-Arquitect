...
<html lang="pt-br">
    <head>
        ...
        <style>
            ...
            .first-section {
                background: url(../imagens/imagens_perfil/beach.jpg);
        ...
        <main>
            ...
            <section class="first-section">
                <div class="first-section-conteudo">
                    <img src="../imagens/imagens_arquitetos/roberta_marroni.png" alt="Imagem de Perfil">
                    <h1 class="name">Robeta Marroni</h1>
                </div>
            </section>
                    ...
                    <div class="left">
                        ...
                        <div class="conteudo-left">
                            <table>
                                ...
                                <tr>
                                    <td>Experiencia: </td>
                                    <td>7 anos de atuação na área</td>
                                </tr>
                            </table>
                        </div>
                    </div>
                        ...
                        <div class="contato-conteudo">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td class="email">robertamarroini@gmail.com</td>
                                </tr>
                                <tr>
                                    <td><img src="../icones/instagram-black.png" alt=""></td>
                                    <td>euRobertaMarroni_</td>
                                </tr>
                            </table>
                        </div>
                    </div>
